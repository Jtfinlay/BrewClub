...
Have a web crawler go through the beer store's website and pull all the beer metadata. If your local beer store is [TotalWine](http://www.totalwine.com), then you're in luck! If not, you need to make your own crawler. Or ask me to make it, which you can do by first ordering me a nice set of beers from [TotalWine](http://www.totalwine.com).
